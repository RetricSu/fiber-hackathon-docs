...
| **Light Paper** | Protocol motivation and high-level design. | [fiber.world/docs](https://www.fiber.world/docs) |
| **Glossary** | Key terms such as HTLC, PTLC, invoices, and routing concepts. | [fiber.world/docs/how-it-works](https://www.fiber.world/docs/how-it-works) |
...
| **Fiber WSS Config Manual** | WebSocket secure configuration for nodes. | [fiber.world/docs/quick-start/run-a-node](https://www.fiber.world/docs/quick-start/run-a-node) |
| **Public Nodes Manual** | How to run a public, discoverable node. | [fiber.world/docs/quick-start/network-resources](https://www.fiber.world/docs/quick-start/network-resources) |
